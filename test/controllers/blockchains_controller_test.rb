...
class BlockchainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blockchain" do
    assert_difference('Blockchain.count') do
      post blockchains_url, params: { blockchain: { deposit: @blockchain.deposit, gas_burnt: @blockchain.gas_burnt, height: @blockchain.height, raw_content: @blockchain.raw_content, receiver: @blockchain.receiver, sender: @blockchain.sender } }
    end
  ...
  test "should update blockchain" do
    patch blockchain_url(@blockchain), params: { blockchain: { deposit: @blockchain.deposit, gas_burnt: @blockchain.gas_burnt, height: @blockchain.height, raw_content: @blockchain.raw_content, receiver: @blockchain.receiver, sender: @blockchain.sender } }
